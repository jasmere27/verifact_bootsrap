...
<head>
 ...
 <style>
    ...
    body.section-bg {
        background-image: url('img/blueb.png'); /* Replace with your image path */
    ...
    <div class="container pt-5">
        <div class="row g-5 pt-5">
            <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                ...
                <h1 class="display-4 text-white mb-4 animated slideInRight">Email Security Best Practices</h1>
                <p class="text-white mb-4 animated slideInRight">
                    Protect yourself and your organization from phishing, spoofing, and email-borne threats.
                </p>
            ...
            <div class="col-lg-6 align-self-end text-center text-lg-end">
                <img class="img-fluid" src="img/email-robo.png" alt="Email Security Illustration">
            </div>
        </div>
    </div>
</div>
...
<!-- Full Page Email Security Section with Background -->
<div class="container-fluid d-flex align-items-center min-vh-100 py-3" 
     style="background: url('img/blueb.png') no-repeat center center; background-size: cover;">
        ...
        <div class="row g-4 align-items-start">
            ...
            <div class="col-lg-8">
                <div class="p-4 shadow-sm" style="
                    ...
                    color: white;
                ">
                    <h3 class="mb-3">Why Email Security Matters</h3>
                    <p>Email remains one of the most common entry points for cyberattacks. Phishing scams, malicious attachments, and spoofed addresses can lead to identity theft, data breaches, and financial loss.</p>

                    <h4 class="mt-4 text-warning">Top Email Security Practices</h4>
                    <ul class="list-group list-group-flush mb-4">
                        <li class="list-group-item" style="background: transparent; color: white;">✅ <strong>Be Wary of Suspicious Links:</strong> Hover to check destinations before clicking.</li>
                        <li class="list-group-item" style="background: transparent; color: white;">✅ <strong>Verify the Sender:</strong> Check email addresses and domains carefully.</li>
                        <li class="list-group-item" style="background: transparent; color: white;">✅ <strong>Use Spam Filters:</strong> Reduce exposure to dangerous content.</li>
                        <li class="list-group-item" style="background: transparent; color: white;">✅ <strong>Enable MFA:</strong> Add extra login security.</li>
                        <li class="list-group-item" style="background: transparent; color: white;">✅ <strong>Don’t Download Unknown Attachments:</strong> Use antivirus tools first.</li>
                        <li class="list-group-item" style="background: transparent; color: white;">✅ <strong>Educate Staff:</strong> Awareness training reduces phishing risk.</li>
                    </ul>

                    <h4 class="mt-4 text-warning">Tools That Help</h4>
                    <ul class="ps-3">
                        <li>📧 <strong>Google Safe Browsing</strong></li>
                        <li>🔐 <strong>Microsoft Defender</strong></li>
                        <li>🛡️ <strong>SpamAssassin</strong></li>
                        <li>🔍 <strong>PhishTank</strong></li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Sidebar Tip -->
            <div class="col-lg-4">
                <div class="h-100 shadow-sm" style="
                    background: rgba(255, 255, 255, 0.1);
                    backdrop-filter: blur(10px);
                    -webkit-backdrop-filter: blur(10px);
                    border-radius: 20px;
                    ...
                    color: white;
                ">
                    <img src="img/quick-tips.jpg" alt="Email Security Tip" class="img-fluid w-100" style="object-fit: cover; height: 200px;">
                    <div class="p-4">
                        <h5 class="text-warning mb-3">Quick Tip</h5>
                        <p>
                            Never respond to urgent requests for passwords or financial details—even if they seem to come from someone you trust.
                        </p>
                    </div>
                </div>
            </div>
